...
class TestUT2():
  ...
  def test_uT2(self):
    ...
    # 11 | type | css=.QO9loc33XC50mMRUCIvf | sơn tùng | 
    self.driver.find_element(By.CSS_SELECTOR, ".QO9loc33XC50mMRUCIvf").send_keys("sơn tùng")
    # 12 | click | css=div:nth-child(1) > .h4HgbO_Uu1JYg5UGANeQ .t_yrXoUO3qGsJS4Y6iXX > .Type__TypeElement-sc-goli3j-0 |  | 
    self.driver.find_element(By.CSS_SELECTOR, "div:nth-child(1) > .h4HgbO_Uu1JYg5UGANeQ .t_yrXoUO3qGsJS4Y6iXX > .Type__TypeElement-sc-goli3j-0").click()
    # 13 | runScript | window.scrollTo(0,0) |  | 
    self.driver.execute_script("window.scrollTo(0,0)")
    # 14 | click | linkText=Tìm kiếm |  | 
    self.driver.find_element(By.LINK_TEXT, "Tìm kiếm").click()
    # 15 | click | css=.QO9loc33XC50mMRUCIvf |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".QO9loc33XC50mMRUCIvf").click()
    # 16 | type | css=.QO9loc33XC50mMRUCIvf | justin | 
    self.driver.find_element(By.CSS_SELECTOR, ".QO9loc33XC50mMRUCIvf").send_keys("justin")
    # 17 | click | css=.\_gB1lxCfXeR8_Wze5Cx9 |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".\\_gB1lxCfXeR8_Wze5Cx9").click()
